...
GROUP_CONCAT(DISTINCT(IF(obs_fscn.name = 'GLOBAL_Nurse_Name', coalesce(o.value_numeric, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS 'Nurses Name'
    ...
    and cast(o.obs_datetime AS DATE) between '2020-04-01'AND '2020-05-21'
    ...
    AND obs_fscn.name IN ('GLOBAL_Type_Of_Visit','GLOBAL_Infant_Weight','GLOBAL_Infant_Height','Lab_Hemoglobin','WAZ_Color','WHZ','2MT5Y_Diagnosis','2M_Serious_Illness',
