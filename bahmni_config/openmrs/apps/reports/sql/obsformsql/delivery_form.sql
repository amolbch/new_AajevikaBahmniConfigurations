...
GROUP_CONCAT(DISTINCT(IF(obs_fscn.name ='Del_Date_And _Time', coalesce(o.value_numeric, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS'Admission date and time',
...
GROUP_CONCAT(DISTINCT(IF(obs_fscn.name ='Delivery_diagnosis', coalesce(o.value_numeric, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS'Diagnosis',
GROUP_CONCAT(DISTINCT(IF(obs_fscn.name ='Del_Date_of_Delivery', coalesce(o.value_numeric, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS'Date and Time of Delivery',
...
GROUP_CONCAT(DISTINCT(IF(obs_fscn.name ='Del_Newborn_complication', coalesce(o.value_numeric, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS'Newborn Complication',
GROUP_CONCAT(DISTINCT(IF(obs_fscn.name ='Del_Date_and_Time_of_discharge', coalesce(o.value_numeric, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS'Date and Time of discharge',
...
GROUP_CONCAT(DISTINCT(IF(obs_fscn.name ='GLOBAL_Nurse_Name', coalesce(o.value_numeric, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS'Nurses Name'
    ...
    and o.obs_group_id in (select obs_id from obs where concept_id=4480 or concept_id=5532 and voided is false)
    ...
    JOIN concept_name obs_fscn on o.concept_id=obs_fscn.concept_id AND obs_fscn.concept_name_type="FULLY_SPECIFIED" AND obs_fscn.voided is false
     AND obs_fscn.name IN ('Delivery_diagnosis','GLOBAL_Doctors_Name','GLOBAL_Nurse_Name')
...
GROUP_CONCAT(DISTINCT(IF(obs_fscn.name ='Del_Outcome', coalesce(o.value_numeric, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS'Outcome',
GROUP_CONCAT(DISTINCT(IF(obs_fscn.name ='Del_specify_reason', coalesce(o.value_numeric, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS'If Referred, Specify Reason',
GROUP_CONCAT(DISTINCT(IF(obs_fscn.name ='Delivery_diagnosis', coalesce(o.value_numeric, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS'Delivery_diagnosis',
GROUP_CONCAT(DISTINCT(IF(obs_fscn.name ='Del_Date_of_Delivery', coalesce(o.value_numeric, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS'Date and Time of Delivery',
GROUP_CONCAT(DISTINCT(IF(obs_fscn.name ='Del_complications_in_delivery', coalesce(o.value_numeric, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS'Were There Complications in Delivery?',
GROUP_CONCAT(DISTINCT(IF(obs_fscn.name ='Del_Specify_complications', coalesce(o.value_numeric, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS'Specify Complications',
GROUP_CONCAT(DISTINCT(IF(obs_fscn.name ='Del_Outcome_Delivery', coalesce(o.value_numeric, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS'Outcome of Delivery',
...
GROUP_CONCAT(DISTINCT(IF(obs_fscn.name ='GLOBAL_Nurse_Name', coalesce(o.value_numeric, o.value_text, o.value_datetime, coded_scn.name, coded_fscn.name), NULL)) ORDER BY o.obs_id DESC) AS'Nurses Name'
        ...
        FROM obs o
    JOIN concept obs_concept ON obs_concept.concept_id=o.concept_id AND obs_concept.retired is false  and o.form_namespace_and_path like '%Delivery Form%'
    and cast(o.obs_datetime AS DATE) between '#startDate#'AND '#endDate#'
    JOIN concept_name obs_fscn on o.concept_id=obs_fscn.concept_id AND obs_fscn.concept_name_type="FULLY_SPECIFIED" AND obs_fscn.voided is false
     AND obs_fscn.name IN ('Del_Date_And _Time','Global_Location_Visit','Del_Gravida','Del_Parity','Del_Abortions','Del_Live_Births','Del_Still_Births',
        'Del_Neonatal_Death','WEIGHT','Global_height','Del_Hemoglobin','Del_Any_High_risk','Del_Outcome','Del_specify_reason','Del_Date_of_Delivery',
        'Del_complications_in_delivery','Del_Specify_complications','Del_Outcome_Delivery','Del_Period_Of_Gestation','Del_N_born_sex','Del_Newborn_Weight'
        'Del_LowBirth_Weight','Del_ANY_Newborn_Compli','Del_Newborn_complication','Del_Date_and_Time_of_discharge','Receipt_number','Fees_Amount',
